...
class AddPropertyForm(FlaskForm):
    ...
    source = SelectField(u'Source',choices = [('Cold Call', 'Cold Call'), ('Whatsapp', 'Whatsapp'), ('Email', 'Email'), ('Facebook', 'Facebook'), ('Instagram', 'Instagram'), ('Company Website', 'Company Website'), ('Dubizzle', 'Dubizzle'), ('Google', 'Google'), ('Agent', 'Agent'), ('Bayut', 'Bayut'), ('Property Finder', 'Property Finder'), ('Walk-In', 'Walk-In')])
...
class AddLeadForm(FlaskForm):
    ...
    subtype = SelectField(u'Type',choices = [('Villa', 'Villa'), ('Apartment', 'Apartment'), ('Residential Floor', 'Residential Floor'), ('Residential Plot', 'Residential Plot'), ('Townhouse', 'Townhouse'), ('Residential Building', 'Residential Building'), ('Penthouse', 'Penthouse'), ('Villa Compound', 'Villa Compound'), ('Hotel Apartment', 'Hotel Apartment'), ('Office', 'Office'), ('Other', 'Other')])
...
class AddDealForm(FlaskForm):
    ...
    sub_status = SelectField(u'Sub Status',choices = [])

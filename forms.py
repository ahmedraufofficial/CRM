...
class AddLeadForm(FlaskForm):
    ...
    source = SelectField(u'Source *',[validators.DataRequired()],choices = [('Cold Call', 'Cold Call'), ('Lead Assigned', 'Lead Assigned') ,('Client Referral','Client Referral'), ('TikTok','TikTok') , ('Whatsapp', 'Whatsapp'), ('Email', 'Email'), ('Facebook', 'Facebook'), ('Snapchat', 'Snapchat'), ('Instagram', 'Instagram'),('Tiktok','Tiktok'), ('Company Website', 'Company Website'), ('Dubizzle', 'Dubizzle'), ('Google', 'Google'), ('Agent', 'Agent'), ('Bayut', 'Bayut'), ('Property Finder', 'Property Finder'), ('Walk-In', 'Walk-In')])

...
@login_required
def biotime_auth():
    url = "http://192.168.0.19:8085/jwt-api-token-auth/"
...
def biotime_report(emp_id, from_date, to_date):
    token = biotime_auth()
    next = "http://192.168.0.19:8085/iclock/api/transactions/?emp_code="+emp_id+"&start_time="+from_date+"&end_time="+to_date
    m = []
    while next != None:
